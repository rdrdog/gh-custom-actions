...
var loadGitStateAsync = async () => {
  const artifactClient = artifact.create();
  const downloadOptions = {
    createArtifactFolder: false
  };
  const downloadResponse = await artifactClient.downloadArtifact(manifestGitStateKey, "", downloadOptions);
...
var generateImageTag = (gitState2) => {
  let imageTag = gitState2.commitSha.substring(0, 7);
  if (process.env.ACT === "true") {
