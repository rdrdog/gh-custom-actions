...
When(
  ...
  async function (this: CommonWorld, verb: string, path: string) {
...
Then(
  "I should get back a status code of {int}",
  async function (this: CommonWorld, statusCode: number) {
...
Then(
  ...
  function (this: CommonWorld, contents: string) {
